...
export const prepData: PrepSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 16, title: "Barang Bawaan Pribadi", badge: "Penting", tips: ["Obat rutin, masker N95, multivitamin, oralit, sunscreen, lip balm, kamera, dll."] },
    ]
  },
  {
    section: "Final Check",
